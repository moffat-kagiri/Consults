...
fitS2 = inla(y ~ Sex + ageFac:RuralUrban + 
  ...
  lincomb = forLincombs, control.compute=list(return.marginals=TRUE))

knitr::kable(fitS2$summary.fixed, digits = 2, caption = "Posterior Quantiles")

#plot prior and posterior

sdRes = Pmisc::priorPostSd(fitS2)
